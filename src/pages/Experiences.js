...
const Experiences = () => {
    ...
    return (
        <div className="experiences">
            ...
            <p>I also have multiple intern experiences. Most of them focus on backend. I learned how to build a scalable server. For example, when I worked in Aiello, I refactored the server API with Java Vert.x which let us split the entire API instance into multiple instances. This can highly increase the availablity and scalibality. Also, when I was in Poshmark. I migrated an application server to increase the reliability and completed the logging features for sped up debugging and avoided errors in production. </p>
